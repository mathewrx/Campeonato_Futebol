...
class Time(BaseModel):
    ...
    def __str__(self):
        ...
        jogadores = ""
        for jota in JogadorDoTime.select():
            jogadores += str(jota.jogador)
        return s + jogadores

class JogadorDoTime(BaseModel):
...
if __name__ == "__main__":
    ...
    db.connect()
    db.create_tables([Socio_torcedor, Tecnico, Jogador, Estadio, Time, JogadorDoTime, Campeonato, Arbitro, Produto, Narrador, Partida])
    ...
    JogadorDoTime.create(jogador = messi, time = flamengo) 
